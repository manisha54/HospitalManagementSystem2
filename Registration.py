...
def registrationform():
    ...
    # Recordframedetails = LabelFrame(Bottom_frame_details, text='Records', bd=7, bg='#FAEBD7',
    ...
    global bg5
    bg5 = PhotoImage(file="deletee..png")
    ...
    appointment_btn = Button(Button_frame_rights, image=bg6, borderwidth=0, height=40, width=250, command=appoint)
