...
def appoint2():
    ...
    def query():
        ...
        for records in record1:
            print_record += str(records[0]) + "\t" + str(records[1]) + str(records[2]) + str(
                records[3]) + " " + "\n"
        query_label = Label(framedetails, text=print_record, bg="#FFE1FF", font=('calibri', 14, 'bold'))
        ...
        query_label1 = Label(framedetails, text=print_record1,bg="#FFE1FF", font=('calibri', 14, 'bold'))
    ...
    global bg6
    bg6 = PhotoImage(file="deletee.png")
