...
def prescribe1():
        ...
        for records3 in record3:
            ...
            for records in recordI:
                print_record += str(records[0]) + "\t" + str(records[1]) + str(records[2]) + str(
                    records[3]) + " " + "\n"
            query_label = Label(records_frame, text=print_record,bg="white",font = ('calibri', 14 , 'bold'))
            query_label.pack()
            ...
            query_label1 = Label(records_frame, text=print_record1, bg="white",font = ('calibri', 14 , 'bold'))
            query_label1.pack()
    ...
    mybutton = Button(root, text="Exit", font=("calibre", 12, "bold"), fg="white", bg="red", command=logout)
    mybutton.place(x=525, y=35)
    ...
    # buttons
    enter_btn = Button(root, text='Enter', font=('calibre', 11, 'bold'), bg='red', fg='white', command=query)
    enter_btn.place(x=265, y=35)
    submit_btn = Button(root, text='Submit', font=('calibre', 11, 'bold'), bg='red', fg='white', command=submit)
    submit_btn.place(x=395, y=35)
    clear_btn = Button(root, text='Clear', font=('calibre', 11, 'bold'), bg='red', fg='white', command=clear)
    clear_btn.place(x=465, y=35)
    delete_btn = Button(root, text='Delete', font=('calibre', 11, 'bold'), bg='red', fg='white', command=delete)
    delete_btn.place(x=325, y=35)
