...
def appoint2():
    ...
    def query():
        ...
        print_record1 = ''
        for records in record1:
            print_record += str(records[1]) + "\t" + str(records[0]) + "\t" + str(records[2]) + '\t' + str(
                records[5]) + " " + "\t"
